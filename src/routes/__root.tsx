...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Albaik Madanapalle — India's Beloved QSR Brand. Browse the menu, place your order and pay at the counter." },
      { name: "author", content: "Albaik Madanapalle" },
      { property: "og:title", content: "Albaik Madanapalle — Fix Your Cravings" },
      { property: "og:description", content: "India's Beloved QSR Brand. Freshly Prepared • Hygienically Cooked." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Albaik Madanapalle — Fix Your Cravings" },
      { name: "twitter:description", content: "India's Beloved QSR Brand. Freshly Prepared • Hygienically Cooked." },
