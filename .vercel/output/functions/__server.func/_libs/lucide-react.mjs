...
const ChefHat = createLucideIcon("chef-hat", __iconNode$w);
...
const Drumstick = createLucideIcon("drumstick", __iconNode$o);
const __iconNode$n = [
  [
    "path",
    {
...
const SquareKanban = createLucideIcon("square-kanban", __iconNode$8);
const __iconNode$7 = [
  [
    "path",
    {
