...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DeZ-f3RF.mjs");
...
const manifest = {
  "267c3512babcdca1069a07bc2a72be73584fa13de292aec8b3abd8c6ea32b2ca": {
    functionName: "claimOwnerRole_createServerFn_handler",
    importer: () => import("./admin.functions-NA_p62U-.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BEfqKPEM.mjs").then((n) => n.e),
    import("./start-borJTr7D.mjs"),
